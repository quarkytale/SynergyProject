%function [covOut, cholOut] = postProcessingCovariance( covIn, nBasis, nDemo)
...
% If not done sometimes covariance values are huge.
   ...
   covTemp1 = ActionModels.boundCovariance( covIn, minCov,  minCorr);
   ...
   [covOut, cholOut] = ActionModels.regularizeCovariance( covTemp1, ...
